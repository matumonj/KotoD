...
public:
	...
	//@{
		...
		/** Constructor with default values.
		  * \param pValue      Value of m_Distance using the measurement unit.
	...
	/** Assign operator
	  * \param pValue       The m_Distance to be assigned to this m_Distance.
	...
	//@{
		/** Equivalence operator.
		  * \param pRHS          The m_Distance to be compared with this m_Distance.
	...
	//@{
		/** Retrieve the measurement unit
		  * \return             The measure unit of the m_Distance.
		  */
		const FbxSystemUnit unit() const;

		/** Retrieve the m_Distance value 
		  * \return             The value of the m_Distance in the defined measurement unit.   
		  */
		float value() const;
	//@}

    /** Get the value of m_Distance when converting this measurement unit to inch.
	  * \return             The value of m_Distance when converting this measurement unit to inch.
	  */
    float internalValue() const;

	/** Get the value of m_Distance when converting this measurement unit to the specified measurement unit.
	  * \param pUnit       The measurement unit to be converted to.
	  * \return            The value of m_Distance when using the specified measurement unit.
	  */
