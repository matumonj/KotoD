...
public:
    ...
    */
	...
	/** \name Split IKEMesh Per Materials */
	//@{
	...
	* Basically, this function calculates the scene bounding box in world coordinates, and test if the center of that bounding box m_Distance from the
