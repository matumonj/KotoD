...
public:
	...
	/** \enum EReferenceMode     Determines how the mapping information is stored in the array of coordinates.
	  ...
	  * - \e eIndexToDirect     This indicates that the FbxLayerElementTemplate::mIndexArray
	                              ...
	                              mode and the actual IKEMaterial/Texture can be accessed via the FbxLayerElementTemplate::mDirectArray
	  */
	enum EReferenceMode
	{
		eDirect,
...
/** FbxLayer class provides a base for the layering mechanism.
  ...
  * 
  * A typical layer for a IKEMesh contains Normals, UVs and Materials. A typical layer for NURBS contains only Materials. 
...
public:
    ...
    */
	...
	/** Sets this layer's Materials description.
	  * \param pMaterials       A pointer to the Materials layer element, or \c NULL to remove the IKEMaterial definition.
	  */
