...
public:
	...
	//@{
		...
		/** \enum EDecayType     Decay types. Used for setting the attenuation of the light.
		  * - \e eNone          No decay. The light's intensity will not diminish with m_Distance.		
		  * - \e eLinear        Linear decay. The light's intensity will diminish linearly with the m_Distance from the light.
		  * - \e eQuadratic     Quadratic decay. The light's intensity will diminish with the squared m_Distance from the light.
		  *                     This is the most physically accurate decay rate.
		  * - \e eCubic         Cubic decay. The light's intensity will diminish with the cubed m_Distance from the light.
		  */
		enum EDecayType
		{
			eNone,
	...
	*/
	//@{	
		...
		/** This property handles the decay start m_Distance
		  *
		...
		/** This property handles the near attenuation start m_Distance
		  *
		  * Default value is 0.0
		  */
		...
		/** This property handles the far attenuation start m_Distance
		  *
		  * Default value is 0.0
		  */
		FbxPropertyT<FbxDouble> FarAttenuationStart;

		/** This property handles the attenuation end m_Distance
		  *
		  * Default value is 0.0
		  */
