...
public:
    ...
    //@{
        ...
        /** Set the near plane m_Distance from the camera.
          * The near plane is the minimum m_Distance to render a scene on the camera display.
	      * A synonym for the near plane is "front clipping plane".
          * \param pDistance     The near plane m_Distance value.
        ...
        /** Get the near plane m_Distance from the camera.
          * The near plane is the minimum m_Distance to render a scene on the camera display.
	      * A synonym for the near plane is "front clipping plane".
        ...
        /** Set the far plane m_Distance from camera.
          * The far plane is the maximum m_Distance to render a scene on the camera display.
	      * A synonym for the far plane is "back clipping plane".
          * \param pDistance     The far plane m_Distance value.
        ...
        /** Get the far plane m_Distance from camera.
          * The far plane is the maximum m_Distance to render a scene on the camera display.
	      * A synonym for the far plane is "back clipping plane".
    ...
    /**
	  ...
	  *
	  * Typically a client application would place the BackPlate a small m_Distance in front of the 
    ...
    */
	...
	/** Front and BackPlane m_Distance modes.
	  * \see SetBackPlaneDistanceMode and GetBackPlaneDistanceMode.
      */
    enum EFrontBackPlaneDistanceMode
    {
        eRelativeToInterest,	//!< The back plane m_Distance is measured in relation to the camera interest.
        eRelativeToCamera		//!< The back plane m_Distance is measured in relation to the camera.
    };

	/** Set the back plane m_Distance mode.
      * \param pMode    The back plane m_Distance mode to set.
      */
    void SetBackPlaneDistanceMode(EFrontBackPlaneDistanceMode pMode);

    /** Get the back plane m_Distance mode.
      * \return     Return the back plane m_Distance mode.
      */
    EFrontBackPlaneDistanceMode GetBackPlaneDistanceMode() const;

	/** Set the front plane m_Distance from the camera. The the absolute position of the plane must be calculated
	  * by taking into consideration of the FrontPlaneDistanceMode.
      * \param pDistance    The front plane m_Distance value.
    ...
    /** Get the front plane m_Distance value.
      * \return double      The front plane m_Distance value.
      */
    double GetFrontPlaneDistance() const;

    /** Set the front plane m_Distance mode.
      * \param pMode        The front plane m_Distance mode to set.
      */
    void SetFrontPlaneDistanceMode(EFrontBackPlaneDistanceMode pMode);

    /** Get the front plane m_Distance mode flag.
      * \return     The front plane m_Distance mode.
      */
    ...
    enum EFocusDistanceSource
    {
        ...
        eFocusSpecificDistance		//!<	Base the depth of field on a point defined by a specific m_Distance from the camera interest.
    };
    ...
    /** This property handles the near plane m_Distance.
      *
      * \remarks This property is read-only.
    ...
    /** This property handles the far plane m_Distance.
      *
      * \remarks This property is read-only.
    ...
    */
    ...
    /** This property handles the back plane m_Distance.
      *
    ...
    /** This property handles the back plane m_Distance mode.
      *
    ...
    /** This property handles the front plane m_Distance.
      *
    ...
    /** This property handles the front plane m_Distance mode.
      *
    ...
    */
    ...
    /** This property handles the focus m_Distance.
	  * Focus m_Distance is the m_Distance between the camera and the object on which the camera is focused. 
	  * There are two possible sources for this m_Distance.
