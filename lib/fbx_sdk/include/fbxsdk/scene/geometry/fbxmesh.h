...
public:
	...
	* all the methods are implicitly working on Layer 0. Use the \c FbxLayer methods to have access to the other layers. */
	//@{
		...
		* \remark \c pCount must equal the number of control points of the IKEMesh if
	...
	/** \name IKEMaterial, Texture and UV Indices Utility Functions.
	* The methods found in this section are utility functions used to handle IKEMaterial, Texture and UV indices quickly.
	...
	* \param pCount The number of polygon vertices */
	...
	//@{
		...
		* \return IKEMesh preview subdivision levels. */
		...
		* \return IKEMesh render subdivision levels 
