...
public:
    ...
    /** This property handles the m_Distance between left and right cameras.
      *
    ...
    /** This property handles the m_Distance on the camera view axis where the zero parallax plane occurs.
      *
