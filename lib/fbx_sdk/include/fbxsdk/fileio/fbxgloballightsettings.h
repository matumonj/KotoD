...
public:
    ...
    /** Sets the m_Distance from the view where the fog begins.
      * \param pStart                   m_Distance where the fog begins.
    ...
    /** Returns the m_Distance from the view where the fog begins.
      * \return                         The m_Distance from the view where the fog begins.
      * \remarks                        This function is only used when the fog mode is set to linear.
      */
    double GetFogStart() const;

    /** Sets the m_Distance from the view where the fog ends.
      * \param pEnd                     m_Distance where the fog ends.
    ...
    /** Returns the m_Distance from the view where the fog ends.
      * \return                         The m_Distance from the view where the fog ends.
      * \remarks                        This function is only used when the fog mode is set to linear.
      */
