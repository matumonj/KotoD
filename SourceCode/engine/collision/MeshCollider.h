...
public:
	...
	/// 三角形の配列を構築する
	/// </summary>
	void ConstructTriangles(IKEModel* model);
	...
	/// <param name="m_Distance">距離（出力用）</param>
	/// <param name="inter">交点（出力用）</param>
	/// <returns>交差しているか否か</returns>
	bool CheckCollisionRay(const Ray& ray, float* m_Distance = nullptr, DirectX::XMVECTOR*inter = nullptr);
