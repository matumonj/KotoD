...
struct ImGuiNavMoveResult
{
    ...
    float           DistBox;            // Best candidate box m_Distance to current NavId
    float           DistCenter;         // Best candidate center m_Distance to current NavId
    float           DistAxial;
...
struct ImGuiContext
{
    ...
    float                   ScrollbarClickDeltaToGrabCenter;    // m_Distance between mouse and center of grab box, normalized in parent space. Use storage?
