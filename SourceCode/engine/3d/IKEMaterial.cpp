...
IKEMaterial* IKEMaterial::Create()
{
	auto instance = new IKEMaterial;
...
void IKEMaterial::Initialize()
{
	// 定数バッファの生成
	CreateConstantBuffer();
}

void IKEMaterial::CreateConstantBuffer()
{
	HRESULT result;
	// 定数バッファの生成
...
void IKEMaterial::LoadTexture(const std::string& directoryPath, CD3DX12_CPU_DESCRIPTOR_HANDLE cpuHandle,
